...
// --- Dummy users (replace with Supabase auth when ready) ---
const DUMMY_USERS = [
  { email: 'owner@washandgo.com', password: 'owner123',    name: 'Owner',          isStaff: true  },
  { email: 'staff@washandgo.com', password: 'staff123',    name: 'Staff',          isStaff: true  },
  { email: 'customer@gmail.com',  password: 'customer123', name: 'Juan Dela Cruz', isStaff: false },
];
// ------------------------------------------------------------
...
export default function AuthPage({ onAuthSuccess }: AuthPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (mode === 'login') {
      ...
      if (match) {
        onAuthSuccess({ name: match.name, email: match.email, isStaff: match.isStaff });
      } else {
      ...
      onAuthSuccess({ name, email, isStaff: false });
    }
  };
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-5xl font-black italic text-white uppercase leading-tight mb-4">
            YOUR CAR,<br />
            <span className="text-orange-500">PREMIUM</span><br />
            CARE.
          </h2>
        ...
        <p className="relative z-10 text-xs text-gray-500">
          &copy; {new Date().getFullYear()} Wash & Go Baliwag Branch
        </p>
      </div>
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="flex items-center gap-4 my-6">
                ...
                <span className="text-xs font-bold text-gray-400 upperc
                ase tracking-wider">or with email</span>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-gray-900 hover:bg-orange-600 text-white rounded-lg font-bold transition-colors mt-2"
                >
