...
import { Search, Calendar, Clock, Car, User, AlertCircle } from 'lucide-react';

interface CheckStatusProps {
  bookings: Booking[];
}

export default function CheckStatus({ bookings }: CheckStatusProps) {
    ...
    <div className="max-w-xl mx-auto animate-fade-in pt-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <form onSubmit={handleSearch} className="relative">
                ...
                <button 
                    type="submit"
                    className="w-full mt-4 bg-gray-900 text-white font-bold py-4 rounded-xl hover:bg-orange-600 transition-colors"
                >
                    CHECK STATUS
                </button>
            </form>
